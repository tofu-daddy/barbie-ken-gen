  ...
  "accessory": "One iconic accessory this Barbie is holding or wearing"
    ...
    return (
      ...
      `}</style>
            ...
            <div style={{
                ...
                {gender !== null && !result && (
                    <>
                        ...
                        {error && <p style={{ color: "#e11d48", textAlign: "center", marginTop: "14px", fontSize: "14px" }}>{error}</p>}
                    ...
                    <div style={{ animation: "fadeIn 0.5s ease-out" }}>
                        ...
                        {(result.outfit || result.accessory) && (
                            <div style={{
                                ...
                                border: `1.5px solid ${accentMid}30`,
                                borderRadius: "14px",
                                padding: "14px 16px",
                                marginBottom: "12px",
                                display: "flex",
                                ...
                                {result.outfit && (
                                    <div style={{ flex: 1 }}>
                                        <p style={{ margin: "0 0 4px", fontSize: "11px", fontWeight: "bold", color: accent, textTransform: "uppercase", letterSpacing: "1px" }}>
                                            {isKen ? "👕 Outfit" : "👗 Outfit"}
                                        </p>
                                        <p style={{ margin: 0, color: accentDark, fontSize: "13px", lineHeight: "1.5" }}>{result.outfit}</p>
                                    </div>
                                )}
                                {result.accessory && (
                                    <div style={{ flex: 1 }}>
                                        <p style={{ margin: "0 0 4px", fontSize: "11px", fontWeight: "bold", color: accent, textTransform: "uppercase", letterSpacing: "1px" }}>
                                            {isKen ? "🎸 Accessory" : "👜 Accessory"}
                                        </p>
                                        <p style={{ margin: 0, color: accentDark, fontSize: "13px", lineHeight: "1.5" }}>{result.accessory}</p>
                                    </div>
                                )}
                            </div>
                        )}
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                            {[
                                ...
                                { emoji: isKen ? "🎸" : "🏠", label: "Dream Setup", value: result.dreamHouse },
            ...
            <p style={{ color: accent, marginTop: "22px", fontSize: "12px", opacity: 0.55, textAlign: "center" }}>
                Powered by Claude AI · Barbieland {isKen ? "⚡" : "💗"} · Images by Pollinations.ai
            </p>
        </div>
    );
}
